...
{
    public partial class WaterFallNodes_FormControl1 : UserControl
    {
        public WaterFallNodes_FormControl1()
        {
            InitializeComponent();
        ...
        _3DGraphControl objWaterfall = null;
        public _3DGraphControl _Waterfall
        {
            get
            {
                return objWaterfall;
        ...
        private void dataGridViewX1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                _Waterfall.DrawWaterfallGraph(xdta, ydta);
                _Waterfall.Refresh();
            }
            catch (Exception ex)
            {
