namespace com.iAM.chart2dnet
{
    ...
    public abstract class ChartPlot : GraphObj
    {
        ...
        internal StringLabel splotLabelTemplate = new StringLabel();
        ...
        public virtual void DrawPolarDatapointValue(Graphics g2, double x, double y, double displayvalue1)
        {
            NumericLabel plotLabelTemplate = this.GetPlotLabelTemplate();
            plotLabelTemplate.SetLocation(x, y);
            plotLabelTemplate.SetNumericValue(displayvalue1);
        ...
        private StringLabel GetPlotLabelStringTemplate()
        {
            ...
            return this.splotLabelTemplate;
        }
