namespace com.iAM.chart2dnet
{
    ...
    public class DoubleArray
    {
        ...
        public DoubleArray(double[] x, int maxcap)
        {
            this.dataBuffer = new double[8];
            this.maxCapacity = 8;
            this.length = 0;
        ...
        public static void CopyArray(DoubleArray source, int sourceoffset, DoubleArray dest, int destoffset, int count)
        {
        ...
        {
            double[] destinationArray = new double[this.length];
        ...
        public void ResizeCapacity(int newcapacity)
        {
            ...
            double[] destinationArray = new double[this.maxCapacity];
        ...
        public void SetElement(int index, double r)
        {
        ...
        public int SetElements(double[] source)
        {
