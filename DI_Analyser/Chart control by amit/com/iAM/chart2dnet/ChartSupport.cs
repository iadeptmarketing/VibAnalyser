namespace com.iAM.chart2dnet
{
    ...
    public class ChartSupport : ChartObj
    {
        ...
        public static bool IsKindOf(object obj, string typestring, bool appendiAM)
        {
            if (obj != null)
            {
                if (appendiAM)
                {
                    ...
                    {
                        typestring = "com.iAM.rtgraphnet." + typestring;
                    }
                    else
                    {
                        typestring = "com.iAM.chart2dnet." + typestring;
                    }
                }
