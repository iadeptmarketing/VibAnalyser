namespace com.iAM.chart2dnet
{
    ...
    {
        internal com.iAM.chart2dnet.GroupDataset displayDataset = null;
        internal int fastClipOffset = 0;
        internal com.iAM.chart2dnet.GroupDataset groupDataset = null;
        ...
        public void Copy(GroupPlot source)
        {
            if (source != null)
            {
                ...
                {
                    this.groupDataset = new com.iAM.chart2dnet.GroupDataset();
        ...
        public com.iAM.chart2dnet.GroupDataset GetGroupDataset()
        {
            return this.groupDataset;
        }
        ...
        public void SetDataset(com.iAM.chart2dnet.GroupDataset dataset)
        {
            int numsegments = 0;
            if (dataset == null)
            {
                dataset = new com.iAM.chart2dnet.GroupDataset("NULL DATASET", 1, 0);
            }
            if (dataset != null)
            {
        ...
        public void SetGroupDataset(com.iAM.chart2dnet.GroupDataset dataset)
        {
            int numsegments = 0;
            if (dataset != null)
            {
        ...
        public com.iAM.chart2dnet.GroupDataset DisplayDataset
        {
            get
            {
                com.iAM.chart2dnet.GroupDataset displayDataset = this.displayDataset;
        ...
        public com.iAM.chart2dnet.GroupDataset GroupDataset
        {
            get
            {
                return this.groupDataset;
