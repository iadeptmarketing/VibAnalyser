namespace com.quinncurtis.chart2dnet
{
    ...
    public class ChartView : UserControl
    {
        ...
        public ChartView()
        {
            this.licenseFilename = "QCLicense.lic.xml";
            ...
            this.productIDStringArray = new string[] { 
                "", "QCChart2D", "QCRTGraph", "QCChart2D CF", "QCRTGraph CF", "", "", "QCSPCChart", "", "", "", "", "", "", "", "", 
                "", "", "", "All Quinn-Curtis .Net Products"
             };
        ...
        private void DrawExpireLicenseMessage(Graphics g2, Rectangle2D drect)
        {
            if (!this.IsLicenseValid() || (lS == 3))
            {
                ...
                if (!this.IsLicenseValid())
                {
                    ...
                    text.AddNewLineTextString(" ");
                    text.AddNewLineTextString("             www.Quinn-Curtis.com     \t\t\t");
                }
                else if (lS == 3)
                {
                    ...
                    text.AddNewLineTextString("   your executable and the QCChartNet.dll (and possibly QCRTGraphNet.dll)");
        ...
        public void DrawObject(Graphics g2, GraphObj graphobject1, Rectangle2D viewrect)
        {
            ...
            if (graphobject1 != null)
            {
                ...
                if (chartInformation.NewLicense && (this.dllMessageFlag == 0))
                {
                    ...
                    else if (str.Equals("com.quinncurtis.rtgraphnet") && !this.IsDLLValid(1))
                    {
