namespace com.quinncurtis.chart2dnet
{
    ...
    internal class ChartInfo : ChartObj
    {
        ...
        public const int QCAllProductID = 0x13;
        public const int QCChart2DCFProductID = 3;
        public const int QCChart2DJavaDLL = 0x10000;
        public const int QCChart2DNetCFDLL = 0x100;
        public const int QCChart2DNetDLL = 1;
        public const int QCChart2DProductID = 1;
        private DataSet QCLicenseDataSet;
        public const int QCRTGraphCFProductID = 4;
        public const int QCRTGraphJavaDLL = 0x20000;
        public const int QCRTGraphNetCFDLL = 0x200;
        public const int QCRTGraphNetDLL = 2;
        public const int QCRTGraphProductID = 2;
        public const int QCSPCChartCFProductID = 8;
        public const int QCSPCChartJavaDLL = 0x40000;
        public const int QCSPCChartNetCFDLL = 0x400;
        public const int QCSPCChartNetDLL = 4;
        public const int QCSPCChartProductID = 7;
        ...
        public ChartInfo()
        {
            ...
            this.licensePath = "";
            this.infoFilename = "";
            this.QCLicenseDataSet = new DataSet("QCLicenseDataSet");
            this.fileFound = true;
        ...
        private void ReadTable(string licensepath, string filename)
        {
            ...
            string str = "";
            DataSet qCLicenseDataSet = this.QCLicenseDataSet;
            qCLicenseDataSet.Locale = new CultureInfo("en");
            try
            {
                qCLicenseDataSet.ReadXml(licensepath + @"\" + filename);
            }
            catch (IOException)
            {
                try
                {
                    qCLicenseDataSet.ReadXml(str + "/" + filename);
                }
                catch (IOException)
                {
                    try
                    {
                        qCLicenseDataSet.ReadXml(filename);
                    }
                    catch (IOException)
                    {
                        return;
            ...
            this.fileFound = true;
            DataTableCollection tables = qCLicenseDataSet.Tables;
        ...
        private void ReadXMLResourceTable(string xmlresource)
        {
            ...
            if (manifestResourceStream != null)
            {
                ...
                try
                {
                    qCLicenseDataSet.ReadXml(manifestResourceStream, XmlReadMode.Auto);
                }
                catch (IOException)
                {
                    return;
