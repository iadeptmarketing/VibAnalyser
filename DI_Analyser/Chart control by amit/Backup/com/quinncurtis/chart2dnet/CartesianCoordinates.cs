namespace com.quinncurtis.chart2dnet
{
    ...
    public class CartesianCoordinates : PhysicalCoordinates
    {
        ...
        {
            com.quinncurtis.chart2dnet.AutoScale compatibleAutoScale = base.xScale.GetCompatibleAutoScale();
            com.quinncurtis.chart2dnet.AutoScale scale2 = base.yScale.GetCompatibleAutoScale();
