...
namespace DI_Analyser.Classes
{
    public sealed class CSysPro 
    {
       ...
       //         //objHasp.TryButtonClicked += new frmHasp.ExitButtonClickedHandler(objHasp_TryButtonClicked);
       //     }//end(if (objHasp != null))
       ...
       //         m_objHasp1.Logout();
       //         //m_objHasp = new Hasp(m_objHaspFeatue);
       //         HaspStatus status = m_objHasp.Login(decrypt(m_sTest));
       //         HaspStatus status1 = m_objHasp1.Login(decrypt(m_sTest));
       //         if (HaspStatus.StatusOk == status || HaspStatus.StatusOk == status1 || HaspStatus.AlreadyLoggedIn == status || HaspStatus.AlreadyLoggedIn == status1)
       //         {
       //             onceLogged = true;
       //             return true;
       //             // m_objHasp.Logout();
       ...
       // public void objHasp_ExitButtonClicked()
       // {
       //     try
       //     {
       ...
       //         System.Diagnostics.Debug.WriteLine(ex.Message, ex.StackTrace);
       //     }//end(catch (Exception ex))
       // }//end(public virtual bool ReturnDongleConnected())
       ...
       //         else
       //         {
       //             //objHasp_DemoButtonClicked();
       //             m_objHaspForm.ShowDialog();// Dialog();

       //         }

       //         //}//end(using (frmHasp objHasp = new frmHasp()))
       //     }
       //     catch (Exception ex)
       //     {
       //         System.Diagnostics.Debug.WriteLine(ex.Message, ex.StackTrace);
       ...
       //public void objHasp_DemoButtonClicked()
       // {
       //     try
       //     {
       ...
       //public void objHasp_TryButtonClicked()
       // {
       //     try
       //     {
       ...
       // }
        ...
        public bool Test()
        {
            try
            {
                ...
                HaspStatus status = m_objHasp.Login(decrypt(m_sTest));
                HaspStatus status1 = m_objHasp1.Login(decrypt(m_sTest));
                return true; // no disabling Hasp Check  Should be removed **************
                if (HaspStatus.StatusOk == status || HaspStatus.StatusOk == status1 || HaspStatus.AlreadyLoggedIn == status || HaspStatus.AlreadyLoggedIn == status1)
                {
                    onceLogged = true;
                    return true;
        ...
        public void ECB()
        {
            try
            {
                if (m_objHaspForm != null)
                {
                    //m_objHaspForm.EnableControlBox();
                    m_objHaspForm.Visible = false;
                }
            }
            catch (Exception ex)
